...
// Agregar un título
$pdf->Cell(0, 10, 'Registro de Donacion', 0, 1, 'C');
$pdf->Ln(10); // Espacio después del título

// Agregar encabezados de columnas con formato
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(0, 10, 'Detalles del Donante', 0, 1, 'L');
$pdf->Ln(5); // Espacio después del encabezado

// Consultar el registro específico de donaciones
if ($id > 0) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $campos = [
            ...
            'Fecha de Donacion' => 'fecha_donacion',
            'Destino de la Donacion' => 'destino_donacion'
        ];
...
$pdf->Output('I', 'registro_donacion.pdf');
?>
